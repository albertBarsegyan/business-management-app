export function EmptyState({ onOpenPanel }: { onOpenPanel: () => void }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #E6E8EB", borderRadius: 8, padding: "72px 40px", display: "flex", flexDirection: "column", alignItems: "center", gap: 14, textAlign: "center" }}>
        ...
        <span style={{ fontFamily: "var(--font-zhamo-display)", fontSize: 38, lineHeight: 1.04, letterSpacing: "-0.026em", fontWeight: 700, maxWidth: "22ch" }}>
