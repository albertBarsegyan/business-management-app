  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        ...
        >
          Add the regulars you already know, or import last year&apos;s book
          from Excel. Clients who use your booking link add themselves.
        </span>
        <div style={{ display: "flex", gap: 8, marginTop: 6 }}>
          ...
          <button
            className="zhamo-teamclients-outline-btn"
            style={{
              height: 38,
              padding: "0 18px",
