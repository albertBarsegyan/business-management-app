    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #E6E8EB", borderRadius: 8, overflow: "hidden", display: "flex", flexDirection: "column" }}>
        ...
        <div className="zhamo-table-scroll" style={{ overflowX: "auto" }}>
          <div className="zhamo-table-head" style={{ display: "grid", gridTemplateColumns: "34px 1.7fr 1.1fr 1.3fr 0.9fr 0.9fr 0.6fr 0.7fr 0.9fr 0.9fr", minWidth: 780, height: 34, alignItems: "center", padding: "0 16px", gap: 8, background: "#FAFBFC", borderBottom: "1px solid #E6E8EB", fontFamily: "var(--font-zhamo-mono)", fontSize: 10, letterSpacing: "0.06em", textTransform: "uppercase", color: "#8A9099" }}>
          ...
          {clientRows.map((c) => (
            <div key={c.name} className="zhamo-teamclients-row zhamo-table-row" style={{ display: "grid", gridTemplateColumns: "34px 1.7fr 1.1fr 1.3fr 0.9fr 0.9fr 0.6fr 0.7fr 0.9fr 0.9fr", minWidth: 780, alignItems: "center", padding: "8px 16px", gap: 8, borderBottom: "1px solid #EEF0F2", fontSize: 12.5, background: c.bg, cursor: "pointer" }}>
              ...
              <span data-label="Name" className="zhamo-table-cell" style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
              ...
              <span data-label="Phone" className="zhamo-table-cell" style={{ fontFamily: "var(--font-zhamo-mono)", fontSize: 11.5, color: "#5B6069" }}>{c.phone}</span>
              <span data-label="Email" className="zhamo-table-cell" style={{ color: "#5B6069", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{c.email}</span>
              <span data-label="Sold" className="zhamo-table-cell" style={{ fontFamily: "var(--font-zhamo-mono)", fontSize: 11.5 }}>{c.sold}</span>
              <span data-label="Balance" className="zhamo-table-cell" style={{ fontFamily: "var(--font-zhamo-mono)", fontSize: 11.5, color: c.balanceColor }}>{c.balance}</span>
              <span data-label="Visits" className="zhamo-table-cell">{c.visits}</span>
              <span data-label="Discount" className="zhamo-table-cell" style={{ color: "#5B6069" }}>{c.discount}</span>
              <span data-label="Last visit" className="zhamo-table-cell" style={{ fontFamily: "var(--font-zhamo-mono)", fontSize: 11.5, color: "#5B6069" }}>{c.last}</span>
              <span data-label="First visit" className="zhamo-table-cell" style={{ fontFamily: "var(--font-zhamo-mono)", fontSize: 11.5, color: "#8A9099" }}>{c.first}</span>
            </div>
          ))}
        </div>
