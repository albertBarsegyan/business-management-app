...
export function TopBar({ empty, onToggleEmpty }: { empty: boolean; onToggleEmpty: () => void }) {
  return (
    <div className="zhamo-topbar" style={{ height: 48, flex: "0 0 auto", background: "#FFFFFF", borderBottom: "1px solid #E6E8EB", display: "flex", alignItems: "center", gap: 8, padding: "0 18px" }}>
      ...
      <span className="zhamo-topbar-label" style={{ marginLeft: "auto", fontFamily: "var(--font-zhamo-mono)", fontSize: 10.5, letterSpacing: "0.12em", textTransform: "uppercase", color: "#A9AEB6" }}>
        Zhamo — management
      </span>
