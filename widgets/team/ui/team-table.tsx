    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #E6E8EB", borderRadius: 8, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div className="zhamo-table-scroll" style={{ overflowX: "auto" }}>
          <div className="zhamo-table-head" style={{ display: "grid", gridTemplateColumns: "2.2fr 1.1fr 0.8fr 0.7fr 0.9fr 1fr 40px", minWidth: 640, height: 34, alignItems: "center", padding: "0 16px", gap: 8, background: "#FAFBFC", borderBottom: "1px solid #E6E8EB", fontFamily: "var(--font-zhamo-mono)", fontSize: 10, letterSpacing: "0.08em", textTransform: "uppercase", color: "#8A9099" }}>
            ...
            <div>
              {teamRows.map((r) => (
                <div
                  ...
                  style={{ display: "grid", gridTemplateColumns: "2.2fr 1.1fr 0.8fr 0.7fr 0.9fr 1fr 40px", minWidth: 640, minHeight: 48, alignItems: "center", padding: "4px 16px", gap: 8, borderBottom: "1px solid #EEF0F2", background: r.bg }}
                >
                  <span data-label="Team member" className="zhamo-table-cell" style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
                  ...
                  <span data-label="Schedule" className="zhamo-table-cell">
                  ...
                  <span data-label="Services" className="zhamo-table-cell" style={{ fontSize: 13, color: "#5B6069" }}>{r.services}</span>
                  <span data-label="Role" className="zhamo-table-cell" style={{ fontSize: 12.5, color: "#16161A" }}>{r.role}</span>
                  <span data-label="Subscription" className="zhamo-table-cell" style={{ display: "flex", alignItems: "center", gap: 7, fontSize: 12.5, color: r.subColor }}>
