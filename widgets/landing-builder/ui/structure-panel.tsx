  ...
  return (
    ...
    >
      ...
      {state.structure.map((row) => (
        ...
        >
          <span style={{ color: "#C9CDD3", fontSize: 12, cursor: "grab" }}>
            {row.grip}
          </span>
          <span
            style={{
          ...
          >
            <span
              style={{
                fontSize: 12.5,
                fontWeight: row.selected ? 600 : row.locked ? 500 : 400,
                color: row.locked || row.on ? "#16161A" : "#A9AEB6",
                whiteSpace: "nowrap",
              }}
            >
              {row.label}
          ...
          {row.locked && (
            <span style={{ fontSize: 10, color: "#A9AEB6", flex: "0 0 auto" }}>
              fixed
            </span>
          )}
          {row.movable && (
            <span
              ...
              style={{
                ...
                flex: "0 0 auto",
                borderRadius: 10,
                background: row.on ? "#22C55E" : "#D5D9DE",
                position: "relative",
