  ...
  return (
    <div
      ...
      style={{
        ...
        background: footerBg,
        borderTop: `1px solid ${footerHairline}`,
        cursor: interactive ? "pointer" : "default",
        outline: footerOutline,
        outlineOffset: -2,
        display: "flex",
    ...
    >
      ...
      {footer.signup && (
        ...
        >
          <span style={{ fontSize: 12.5, color: footerInk, paddingTop: 12 }}>
            Get offers by SMS
          </span>
          <span
            style={{
              ...
              minWidth: 180,
              borderRadius: 7,
              border: `1px solid ${footerInputBorder}`,
      ...
      >
        <span style={{ fontSize: 11.5, color: footerMuted }}>
          © 2026 Studio Aram · Privacy · Terms · Cancellation policy
        </span>
