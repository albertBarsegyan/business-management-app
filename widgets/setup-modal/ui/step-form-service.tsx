  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 420 }}>
      <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        <span style={{ fontSize: 12, fontWeight: 500, color: "#5B6069" }}>Service name</span>
        <input placeholder="Example: Haircut" style={{ height: 32, padding: "0 10px", border: "1px solid #D5D9DE", borderRadius: 6, fontFamily: "inherit", fontSize: 13 }} />
      </label>
      <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        <span style={{ fontSize: 12, fontWeight: 500, color: "#5B6069" }}>Category</span>
        <input placeholder="Example: Haircuts" style={{ height: 32, padding: "0 10px", border: "1px solid #D5D9DE", borderRadius: 6, fontFamily: "inherit", fontSize: 13 }} />
      </label>
      <label style={{ display: "flex", flexDirection: "column", gap: 6, maxWidth: 180 }}>
        ...
        <span style={{ display: "flex", height: 32, border: "1px solid #D5D9DE", borderRadius: 6, overflow: "hidden" }}>
          <input placeholder="6 000" style={{ flex: 1, minWidth: 0, border: 0, padding: "0 10px", fontFamily: "inherit", fontSize: 13, outline: "none" }} />
          ...
          {durations.map((label) => {
            ...
            return (
              <span
                ...
                style={{ height: 32, padding: "0 15px", borderRadius: 6, fontSize: 13, display: "inline-flex", alignItems: "center", gap: 7, cursor: "pointer", border: `1px solid ${d.border}`, background: d.bg, color: d.color, fontWeight: d.weight }}
              >
                <span style={{ width: 12, height: 12, borderRadius: "50%", border: `1px solid ${d.dotBorder}`, background: d.dotBg }} />
                {d.label}
              </span>
            );
          })}
