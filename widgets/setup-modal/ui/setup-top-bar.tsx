  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        >
          The calendar can&apos;t render without these three. No close button,
          no skip — but each step is one screen of typing, and the left pane
          shows the calendar assembling itself as you go.
        </p>
      </div>
