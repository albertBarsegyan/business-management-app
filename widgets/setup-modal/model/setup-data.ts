...
export const serviceSkeleton = [
  {
    live: true,
    text: "Men's haircut · 60 min · 6 000 ֏",
    border: "#FFC935",
    bg: "#FFFDF6",
    tile: "#FFC935",
    bar: "#E4E7EB",
...
export const walkthrough = [
  {
    n: "1",
    text: "Click a free slot in the calendar — the appointment panel opens on that time.",
  },
  {
    n: "2",
    text: "Type the client's phone; Zhamo matches them or creates the card as you type.",
  },
  {
    n: "3",
    text: "Save. They get a confirmation SMS, and the slot turns yellow on your day.",
  },
];
