          ...
          {flow.bookingUnavailable ? (
            <>
              ...
              <span style={{ fontSize: 12, color: "#8A9099", lineHeight: 1.5 }}>
                {flow.bookingUnavailableMessage}
              </span>
            </>
          ) : (
            <button
      ...
      {flow.contactStep && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <label style={{ display: "flex", flexDirection: "column", gap: 7 }}>
            ...
            <input
              value={flow.contactName}
              onChange={(e) => flow.setContactName(e.target.value)}
              style={{
                height: 48,
                padding: "0 14px",
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 7 }}>
            ...
            <textarea
              value={flow.contactComment}
              onChange={(e) => flow.setContactComment(e.target.value)}
          ...
          <span style={{ fontSize: 12, color: "#A9AEB6", lineHeight: 1.5 }}>
            No account, no password. We text you the confirmation and a reminder
            two hours before.
          </span>
        </div>
      )}
