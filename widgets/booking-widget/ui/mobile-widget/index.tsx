...
export function MobileWidget({ flow }: { flow: BookingFlow }) {
  return (
    <>
      <div className="zhamo-mobile-widget-frame" style={{ width: 390, flex: "0 0 auto", borderRadius: 30, background: "#16161A", padding: 10, boxShadow: "0 24px 60px rgba(10,10,14,0.28)" }}>
        <div className="zhamo-mobile-widget-screen" style={{ borderRadius: 22, background: "#FFFFFF", overflow: "hidden", height: 780, display: "flex", flexDirection: "column" }}>
          <div className="zhamo-mobile-widget-statusbar" style={{ height: 32, flex: "0 0 auto", background: ACCENT_DEEP, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 18px", color: "#FFFFFF", fontFamily: "var(--font-zhamo-mono)", fontSize: 10.5 }}>
            <span>9:41</span>
            <span>▮▮▮ ⌁ ▰</span>
          </div>
