      ...
      >
        ...
        <span style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <span style={{ fontSize: 12, color: "#5B6069" }}>
            {flow.anySpecialistMeta}
          </span>
        </span>
        <span style={{ marginLeft: "auto", fontSize: 14, color: ACCENT }}>
          {flow.anyCheck}
        </span>
      </div>
        ...
        >
          <span
            style={{
              ...
              borderRadius: "50%",
              background:
                "repeating-linear-gradient(135deg, #EDEFF2 0 4px, #E4E7EB 4px 8px)",
              display: "inline-flex",
              alignItems: "center",
              justifyContent: "center",
          ...
          >
            <span style={{ fontSize: 12.5, color: "#8A6A05", fontWeight: 600 }}>
              ★ {p.rating}
            </span>
