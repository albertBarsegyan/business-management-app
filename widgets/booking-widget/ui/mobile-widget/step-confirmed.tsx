  ...
  return (
    ...
    >
      {flow.taken && (
        ...
        >
          <span style={{ fontSize: 14, fontWeight: 700, color: "#C7302F" }}>
            15:00 was just taken
          </span>
          <span style={{ fontSize: 12.5, color: "#8A6A6A", lineHeight: 1.45 }}>
            Someone booked it 20 seconds before you. Your services and details
            are still here — pick another time and you&apos;re done.
          </span>
          <div
            style={{
              display: "grid",
      ...
      {flow.confirmed && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <span style={{ fontSize: 11.5, color: "#A9AEB6", lineHeight: 1.5 }}>
            Free to cancel until 12:30 on 13 August — two hours before. After
            that, call the salon.
          </span>
        </div>
      )}
