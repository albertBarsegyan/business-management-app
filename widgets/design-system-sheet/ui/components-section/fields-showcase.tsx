  ...
  return (
    ...
    >
      ...
      <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <div
          style={{
            ...
            borderRadius: 6,
            boxShadow: "0 0 0 3px rgba(44,108,246,0.14)",
            overflow: "hidden",
          }}
        >
          <span
      ...
      <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <span style={{ fontSize: 11, color: "#C7302F" }}>
          Enter a price, or mark the service as free.
        </span>
      </label>
      <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        <span style={{ fontSize: 12, fontWeight: 500, color: "#A9AEB6" }}>
          Industry
        </span>
        <div
          style={{
