const tableRows = [
  {
    ...
    role: "· Barber",
    initials: "KS",
    avatarBg: "oklch(0.64 0.16 350)",
    schedule: "until 06.09.2026",
    schedColor: "#17753C",
    services: "12",
    bg: "#FFFFFF",
  },
    ...
    >
      ...
      >
        ...
        {tableRows.map((r) => (
          ...
          >
            ...
            <span style={{ color: r.schedColor, fontSize: 12 }}>
              {r.schedule}
            </span>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        >
          ...
          <span style={{ fontSize: 13, fontWeight: 600, color: "#17753C" }}>
            Appointment saved
          </span>
          <span
            style={{
        ...
        >
          <span style={{ fontSize: 13, fontWeight: 600, color: "#C7302F" }}>
            Couldn&apos;t save — the slot was taken
          </span>
          <span style={{ fontSize: 12, color: "#8A6A6A" }}>
            Karen Sahakyan took 14:30. Nearest free: 15:00.
          </span>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            Click any free slot in the calendar, or add someone from the waiting
            list.
          </span>
          <button
            style={{
