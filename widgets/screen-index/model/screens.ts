...
export const screenCards: ScreenCard[] = [
  ...
  },
  {
    ...
    href: "/team",
    title: "Team",
    body: "Grouped team table with schedule badges, roles, specializations and invites for the people who work for you.",
    states: ["grouped by position", "schedule badges", "add member"],
  ...
  },
  {
    ...
    href: "/clients",
    title: "Clients",
    body: "Client base with segments, locked columns and bulk actions for the people who book with you.",
    states: ["segments", "empty", "add client"],
    tile: "oklch(0.64 0.16 20)",
    tileText: "#FFFFFF",
  },
  {
    n: "07",
