...
export function ScreenIndex() {
  return (
    <div style={{ minHeight: "100vh", padding: "clamp(40px, 9vw, 80px) clamp(16px, 5vw, 56px) clamp(56px, 12vw, 120px)", display: "flex", flexDirection: "column", alignItems: "center", background: "#14141A", color: "#FFFFFF" }}>
